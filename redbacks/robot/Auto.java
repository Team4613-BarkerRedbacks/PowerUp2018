...
//				);
			case(203):
				return createAuto(
					...
					//3rd cube
					new AcSeq.Parallel(
							new AcDoNothing(new ChNumSen(-45, sensors.yaw, false, false, false)),
							new AcSetArm(-armBasePos)
					),
					new AcTurn(-80),
