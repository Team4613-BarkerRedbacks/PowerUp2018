...
//				),
	...
	public AcStraightLenientAfterDistance(double distance, double angle, NumericSensor encoder, boolean shouldReset, double safetyDistance, GettableNumber minOut, GettableNumber maxOut) {
		this(distance, angle, encoder, shouldReset, safetyDistance);
		this.minOut = minOut;
		this.maxOut = maxOut;
	}
