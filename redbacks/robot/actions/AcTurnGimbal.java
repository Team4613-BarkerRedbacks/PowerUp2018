...
//		double rot = rotationOut.output;
		double rot = (angle > Robot.sensors.yaw.get() ? 1 : -1);

		if(onLeftSide) Robot.driver.drivetrain.tankDrive(rot, (rot > 0 ? -1 : 1) * 0.7);
		else Robot.driver.drivetrain.tankDrive((rot > 0 ? 1 : -1) * 0.7, -rot);
